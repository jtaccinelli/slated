...
Patterns of repeated error across takes that suggest a gap in a role definition or background document. Omit entirely if no meaningful patterns emerged.
